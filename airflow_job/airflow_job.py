...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-hvm")
    bq_project = Variable.get("bq_project", default_var="helical-bonsai-462910-p0")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "925122835259-compute@developer.gserviceaccount.com",
                "network_uri": "projects/helical-bonsai-462910-p0/global/networks/default",
                "subnetwork_uri": "projects/helical-bonsai-462910-p0/regions/asia-south1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="helical-bonsai-462910-p0",
        region="asia-south1",
